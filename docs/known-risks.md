...
- The current Milestone 5 slice now performs a one-shot WireGuard initiation/response handshake plus authenticated transport send/receive, but cookie replies, reconnect policy, and rekeying are still not implemented.
