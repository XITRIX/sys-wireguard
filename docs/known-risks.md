...
- The live connect path now resolves IPv4 endpoints and uses a bounded one-shot UDP exchange, but it still has no persistent packet loop, no keepalive scheduling, and no retransmit/backoff handling.
